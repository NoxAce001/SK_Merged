...
const MainSliderUploadPage = () => {
  ...
  const handleSaveToCloudinary = async () => {
    ...
    try {
      ...
      setUploading(false);
      setSuccessMessage('All images have been published to the main slider!');
      ...
      <div className="max-w-5xl ">
        <div className="bg-white shadow-md rounded-lg overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-black to-gray-800 px-6 py-4">
            <h1 className="text-2xl font-bold text-white">Homepage Main Slider Management</h1>
            <p className="text-blue-100 mt-1">Upload and manage your homepage slider images (maximum 10)</p>
          </div>
        ...
        {allImages.length > 0 && (
          <div className="mt-8 bg-white shadow-md rounded-lg overflow-hidden">
            <div className="bg-gradient-to-r from-gray-700 to-gray-900 px-6 py-4">
              <h2 className="text-xl font-bold text-white">Slider Preview</h2>
              <p className="text-gray-300 mt-1">This is how your slider will appear on the homepage</p>
            </div>
            
            <div className="p-6">
              <div className="relative aspect-w-16 aspect-h-7 bg-black rounded-lg overflow-hidden">
                {allImages.length > 0 && (
                  <img 
                    src={allImages[0].url} 
                    alt="Preview" 
              ...
              <p className="text-sm text-gray-500 mt-2 text-center">
                Images will cycle automatically on the homepage slider
              </p>
            </div>
          </div>
        )}
...
export default MainSliderUploadPage;
